...
class AIService:
    ...
    async def summarize_proposal(
        ...
        try:
            ...
            logfire.error("Failed to summarize proposal", proposal_id=proposal.id, error=str(e))
            raise
    ...
    async def _generate_summary(
        ...
        prompt = self._build_analysis_prompt(proposal, include_risk_assessment, include_recommendations)
    ...
    async def _call_ai_model(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(result, 'data'):
                ...
                return {"summary": str(result), "key_points": [], "risk_level": "NOT_ASSESSED", 
                       "recommendation": "NOT_PROVIDED", "confidence_score": 0.5}

...
class TestPearlLoggingConfiguration:
    ...
    def test_pearl_logging_environment_integration(self):
        ...
        """
        test_config = {"LOG_LEVEL": "WARNING", "LOG_FILE_PATH": "/pearl/logs/agent.log"}
    ...
    def test_pearl_logging_config_method(self):
        ...
        """
        with patch.dict(
            os.environ, {"LOG_LEVEL": "DEBUG", "LOG_FILE_PATH": "debug.log"}
        ):
            settings = Settings()
            config = settings.get_pearl_logging_config()

            expected_config = {"log_level": "DEBUG", "log_file_path": "debug.log"}

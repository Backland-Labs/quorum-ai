...
class TestCacheSerialization:
    ...
    def test_round_trip_serialization(self):
        ...
        complex_data = {
            ...
            "metadata": {"count": 1, "cached_at": "2024-01-01T00:00:00Z"},
        }
...
class TestCacheInvalidationUtilities:
    ...
    async def test_invalidate_cache_by_pattern_basic(
        self, setup_cache_invalidation_service
    ):
    ...
    async def test_invalidate_cache_by_pattern_no_matches(
        self, setup_cache_invalidation_service
    ):
    ...
    async def test_invalidate_pattern_handles_redis_errors(
        self, setup_cache_invalidation_service
    ):

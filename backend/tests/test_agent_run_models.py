...
class TestAgentRunRequest:
    ...
    def test_agent_run_request_creation_with_all_fields(self) -> None:
        ...
        request = AgentRunRequest(space_id="test-space-456", dry_run=True)
    ...
    def test_agent_run_request_creation_fails_with_missing_required_fields(
        self,
    ) -> None:
...
class TestAgentRunResponse:
    ...
    def test_agent_run_response_creation_fails_with_missing_required_fields(
        self,
    ) -> None:

...
def test_safe_service_comprehensive_coverage():
    ...
    with patch.dict(
        ...
        mock_settings.eas_contract_address = (
            "0xa4b86402045410f938738ea6e3f8d6d5ab8f9745"
        )
        ...
        with (
            ...
            async def test_submit_transaction_comprehensive():
                ...
                with (
                    ...
                    patch("services.safe_service.Safe") as mock_safe_class,
                    patch(
                        "services.safe_service.TransactionServiceApi"
                    ) as mock_tx_service_class,
                    ...
                    mock_safe_tx.safe_nonce = 5
                    mock_safe_tx.safe_tx_hash = (
                        b"\x01" * 32
                    )  # Return bytes instead of mock
                ...
                with (
                    ...
                    mock_safe_tx.signatures = b"signature"
                    mock_safe_tx.call.side_effect = Exception(
            ...
            with (
                ...
                patch(
                    "utils.abi_loader.load_abi",
                    return_value=[{"name": "attestByDelegation"}],
                ),
                ...
                mock_settings_patch.eas_contract_address = (
                    "0xa4b86402045410f938738ea6e3f8d6d5ab8f9746"
                )

                mock_generate_sig.return_value = (
                    b"\x01" * 32 + b"\x02" * 32 + b"\x1b"
                )  # 65-byte signature
                ...
                try:
                    ...
                    print(
                        f"Expected exception in attestation transaction building: {e}"
                    )
            ...
            try:
                with (
                    ...
                    patch.dict(
                        os.environ, {"ETHEREUM_PRIVATE_KEY": "env_private_key_123"}
                    ),
                ):
                    mock_settings_patch.attestation_chain = "base"
                    mock_settings_patch.eas_schema_uid = "0x" + "a" * 64
            ...
            with patch("services.safe_service.settings") as mock_settings_patch:
                mock_settings_patch.attestation_tracker_address = (
                    "0xa4b86402045410f938738ea6e3f8d6d5ab8f9745"
                )
                mock_settings_patch.eas_contract_address = (
                    "0xa4b86402045410f938738ea6e3f8d6d5ab8f9746"

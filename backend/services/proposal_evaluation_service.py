...
class ProposalEvaluationService:
    ...
    def __init__(self):
        ...
        self.governance_risk_keywords = {
            'high': ['voting', 'mechanism', 'governance', 'quorum', 'threshold', 'power'],
    ...
    async def analyze_proposal_impact(self, proposal: Proposal) -> Dict[str, Any]:
        ...
        return {
            ...
            'estimated_amount': treasury_result['treasury_impact']['amount'] if treasury_result['treasury_impact'] else 0,
        ...
        for pattern, pattern_type in self.treasury_patterns:
            ...
            if match:
                try:
                    ...
                    if (re.match(r'^[A-Z]{2,6}$', currency) and 
                        currency not in ['TOKENS', 'TOKEN', 'COINS', 'COIN']):
                        return {
                            'treasury_impact': {
                                'amount': amount,
                                'currency': currency

    ...
    def decorator(func: F) -> F:
        ...
        def sync_wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.warning(f"Sync function {func.__name__} using cache decorator - cache disabled")
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                if not cache_service.is_available:
                    logger.warning(f"Cache service unavailable for {func.__name__}, calling function directly")

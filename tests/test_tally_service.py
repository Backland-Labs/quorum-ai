...
class TestTallyService:
    ...
    @pytest.fixture
    def tally_service(self) -> TallyService:
        """Create a TallyService instance for testing."""
        return TallyService()

    @pytest.fixture
    def mock_dao_response(self) -> dict:
    ...
    @pytest.fixture
    def mock_single_dao_response(self) -> dict:
    ...
    @pytest.fixture
    def mock_proposals_response(self) -> dict:
        """Create mock proposals response data."""
        return {
            "data": {
                "proposals": {
                    "pageInfo": {"count": 2},
    ...
    @pytest.fixture
    def mock_single_proposal_response(self) -> dict:
        """Create mock single proposal response data."""
        return {
            "data": {
                "proposal": {
                    "id": "prop-1",
